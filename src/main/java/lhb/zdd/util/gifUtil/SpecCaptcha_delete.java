 ...
 * @version:1.0
 */
public class SpecCaptcha_delete extends Captcha
{
    public SpecCaptcha_delete()
    {
    }
    public SpecCaptcha_delete(int width, int height)
    {
        this.width = width;
        this.height = height;
    }
    public SpecCaptcha_delete(int width, int height, int len){
        this(width,height);
        this.len = len;
    }
    public SpecCaptcha_delete(int width, int height, int len, Font font){
